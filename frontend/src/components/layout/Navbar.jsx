  ...
  return (
    <div className="fixed top-0 left-0 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5">
      ...
      <Link to="/" className="max-md:flex-1">
        <img src={assets.xoxo} className="w-20 h-auto" alt="" />
      </Link>
      ...
      <div className="flex items-center gap-8">
        ...
        {!user ? (
          <button className="px-4 py-1 sm:px-7 sm:py-2 bg-amber-500 text-white transition rounded-full font-medium cursor-pointer">
            Login
          </button>
        ) : (
          <UserButton />
